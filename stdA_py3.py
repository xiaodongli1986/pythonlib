...
import os, random, scipy.integrate, copy, sys, time, datetime, timeit
...
def get_color_style(sepreturn=False,init=False):
    ...
    if init: NOW_PLOT_COLOR = 0; NOW_PLOT_STYLE = 0;
    if sepreturn:
