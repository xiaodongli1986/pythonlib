     ...
     for smu__intxi__settings in smu__intxi__settings_list:
      ...
      for Sky in Skylist:
       ...
       for normedintxi in normedintxilist:
		...
		if False: ### nuisance test of printing systematic correction value
		### BOSSLi Begin
 		 print 'Print information of sys cor...'
		 print catname2_RSDCor
                 ...
                 print Sky
                 for X in avgdiffs_simulation_mock:
			print X
		 print '##################'
                 for X in   avgintxis_simulation_mock:
			print X
                 return
		## BOSSLi End
