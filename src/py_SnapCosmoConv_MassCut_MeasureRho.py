...
printstr = '''Postprocess a Snapshot sample
...
#################################
####  Usage: 
            py_SnapCosmoConv_MassCut_MeasureRho   -inputfile inputfile    -omin omin -win win -omout omout -wout wout    -boxsize boxsize -redshift redshift   -nbar nbar    -numNBs numNBs  -margins margins   -rm_tmpfiles F -rmcmd /us/bin/rm  -xcol xcol -ycol ycol -zcol zcol -masscol masscol  -create_random T -random_rat 10  (col start with 1)
